...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-120px)] w-full bg-gradient-to-b from-blue-900 to-blue-600 flex flex-col px-4 sm:px-4">
      <div className="flex flex-col items-center w-full max-w-4xl mx-auto mt-6 sm:mt-10">
        ...
        <p className="text-white text-base sm:text-lg mb-4 text-center drop-shadow max-w-2xl px-4">
