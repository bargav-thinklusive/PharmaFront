      ...
      <div className="max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm">
            ...
            <p className="text-gray-600 mb-2 text-sm sm:text-base">Email: info@chembank.com</p>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm">
            ...
            <p className="text-gray-600 mb-2 text-sm sm:text-base">Email: support@chembank.com</p>
